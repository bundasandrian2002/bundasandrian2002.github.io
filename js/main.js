...
sr.reveal(`.change-theme`, {origin: 'top', distance: '60px', delay: 500, opacity: 0, duration: 1500, easing: 'cubic-bezier(0.34, 1.56, 0.64, 1)'})
...
sr.reveal(`.profile__name`, {origin: 'top', distance: '60px', duration: 900, delay: 350, easing: 'cubic-bezier(0.34, 1.56, 0.64, 1)', opacity: 0})
sr.reveal(`.profile__profession`, {origin: 'top', distance: '60px', duration: 900, delay: 500, easing: 'cubic-bezier(0.34, 1.56, 0.64, 1)', opacity: 0})
sr.reveal(`.profile__social`, {origin: 'top', distance: '60px', duration: 900, delay: 650, easing: 'cubic-bezier(0.34, 1.56, 0.64, 1)', opacity: 0})
sr.reveal(`.profile__info-group`, {origin: 'top', distance: '60px', duration: 900, interval: 100, delay: 700, easing: 'cubic-bezier(0.34, 1.56, 0.64, 1)', opacity: 0})
sr.reveal(`.profile__buttons`, {origin: 'top', distance: '60px', duration: 900, delay: 800, easing: 'cubic-bezier(0.34, 1.56, 0.64, 1)', opacity: 0})
